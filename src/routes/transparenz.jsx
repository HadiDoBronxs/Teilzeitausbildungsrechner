...
export default function Transparenz() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900 px-4 py-12">
      <article className="max-w-3xl mx-auto bg-white shadow rounded-2xl p-6 space-y-4">
        <h1 className="text-3xl font-bold">{t("transparency.title")}</h1>
        <section id="berechnung" className="space-y-6">
          <p className="text-lg text-slate-700">{t("transparency.subtitle")}</p>
